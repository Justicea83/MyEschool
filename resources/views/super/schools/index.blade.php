        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 clear-padding-xs">
                    <h5 class="page-title"><i class="fa fa-user-secret"></i>ALL SCHOOLS</h5>
                ...
                <div class="col-lg-12 clear-padding-xs">
                    <div class="col-lg-12">
                        <div class="dash-item first-dash-item">
                            <h6 class="item-title"><i class="fa fa-user"></i>SCHOOLS</h6>
                            <div class="inner-item">
                                <table id="attendenceDetailedTable" class="display responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th class="hidden-xs"><i class="fa fa-envelope-o"></i>LOCATION</th>
                                        <th class="hidden-xs"><i class="fa fa-tasks"></i>EMAIL</th>
                                        <th class="hidden-xs"><i class="fa fa-tasks"></i>ADMIN</th>
                                        <th class="hidden-xs"><i class="fa fa-tasks"></i>ID</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    @foreach($data as $item)
                                        <tr>
                                            ...
                                            <td class="hidden-xs">{{$item->admin}}</td>
