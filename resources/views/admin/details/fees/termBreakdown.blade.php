                    ...
                    <div class="dash-item first-dash-item">
                        ...
                        <div class="inner-item">
                            <table id="datatable" class="table table-responsive table-bordered table-striped display responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                <tr>
                                    <th class="hidden-xs text-center"><i class="fa fa-code"></i>TERM</th>
                                ...
                                @foreach($data as $item)
                                    <tr>
                                        ...
                                        <td class="hidden-xs text-center">
                                            <a class="btn btn-primary btn-sm " href="{{route('admin.details.fees.actual_items.details',['id'=>$item->id])}}" title="Edit"><i class="fa fa-eye"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
