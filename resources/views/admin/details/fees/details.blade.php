            ...
            <div class="row">
                <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                    <div class="dash-item first-dash-item">
                        <h6 class="item-title" style="text-transform: uppercase;"><i class="fa fa-user"></i>{{$name->name}}
                            <br><br> {{$name->academic_name}} <br><br> {{$name->display_name}}</h6>
                        <div class="inner-item">
                            <table id="datatable" class="table table-responsive table-bordered table-striped display responsive nowrap" width="100%">
                                <thead>
                                <tr>
                                    <th class="text-center"><i class="fa fa-user-secret"></i>ITEM NAME</th>
                                    <th class="text-center"><i class="fa fa-user-secret"></i>AMOUNT</th>
                                ...
                                @foreach($data as $item)
                                    <tr>
                                        ...
                                        <td class="text-center"><?php
                                            echo '<strong>'. number_format($item->amount,2).'</strong>';
                                            ?></td>
                                        <td class="hidden-xs">
                                            <a class="btn btn-primary btn-sm" href="#" title="Edit"><i class="fa fa-pencil"></i></a>
                                            <a class="delete btn btn-primary btn-sm" href="#" data-id="{{$item->id}}" title="Delete" ><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
