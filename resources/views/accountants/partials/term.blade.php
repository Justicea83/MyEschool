<table id="termTable" class="display responsive nowrap" cellspacing="0" width="100%">
    <thead>
    <tr>
    ...
    @foreach($termly as $item)
        <tr>
            ...
            <td>
                <a title="View Transaction Details" href="{{route('transactions.show',['id'=>$item->id])}}" class="btn btn-primary btn-sm">
